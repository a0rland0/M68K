...
#define DEFAULT_DFLG        (M68K_DFLG_ALLOW_FMOVE_KFACTOR | M68K_DFLG_ALLOW_ADDRESS_OPERAND | M68K_DFLG_ALLOW_BANK_EXTENSION_WORD)
#define DEFAULT_DTFLG       M68K_DTFLG__DEFAULT__ & ~(M68K_DTFLG_C_HEXADECIMALS)
